...
| 🟠 Soon | **Memory-as-Tools Promotion** | Canary week dogfooding tools mode, then ADR-025 status flip from Proposed to Accepted. Requires aggregate metrics to prove token-budget reduction. |

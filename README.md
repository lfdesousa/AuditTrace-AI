...
- ✅ **Comprehensive Test Suite** -- 2798 tests, 98% coverage, 90% per-file gate enforced in CI ([latest run](https://github.com/lfdesousa/AuditTrace-AI/actions/workflows/ci.yml)).
...
# Run tests (90% per-file coverage enforced; full suite is 2798 tests / 98% total)
make test

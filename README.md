...
​Copyright © 2026 Luis Filipe de Sousa (allaboutdata.eu). All rights reserved.
...
​Licensing: While the core engine is licensed under AGPL v3 to support Open Science, the underlying theoretical framework and specific architectural designs (ADRs) remain the intellectual property of allaboutdata.eu.
